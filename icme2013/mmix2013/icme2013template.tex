...
Spatial media fragment {\sc uri}s are currently not implemented
in any of the existing Web browsers.
In consequence, in order to support spatial media fragments,
we use a~so-called JavaScript polyfill made available by Thomas Steiner.%
