...
\begin{lstlisting}[caption={Media fragment consisting of rectangular tile with dimensions $ 40 \times 30 $ pixels starting at pixel coordinates $ (0, 0) $ for a~10 sec video subsegment of a~given video media item},
  label=code:media-fragment, float=t!]
@prefix ma: <http://www.w3.org/ns/ma-ont> .

<vid.ogv> a ma:MediaResource ;
<vid.ogv#t=,10&xywh=0,0,40,30> a ma:MediaFragment ;
\end{lstlisting}
