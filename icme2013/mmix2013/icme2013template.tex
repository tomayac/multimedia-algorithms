...
for the different debug scenarios. 
...
from \autoref{fig:near-duplicate}, \autoref{fig:algorithmdebug},
and \autoref{fig:similar-different} is represented by the first quote below.
...
We treat and address each tile as a~spatial media fragment.
