...
In this paper, we investigate in how far
Media Fragments {\sc uri}~\cite{troncy2012mediafragments}
combined with speech synthesis provide a~feasible way
...
In order to provide answers to the human raters' information needs above,
