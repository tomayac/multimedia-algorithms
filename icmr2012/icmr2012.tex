...
===
Problem: In the long-term, we want to summarize events based on social network data.
Research Challenge: Media items spread over several social networks.
Solution:
  1) We need to extract the media items.
  2) We need to make sense of them.
  3) We need to rank them.
  4) We need to represent them.
In this paper, we address 1) and 2), discuss 3), and envision 4).  
}
\end{abstract}
