...
with sometimes news agencies featuring user-generated content from normal social network users.
...
huge potential lies in the information about such events,
...
Different from ImageCLEF and TRECVID, that both deal with content-based analysis of and retrieval from images and videos,
...
%TS: I removed the quote entirely.
\paragraph{Event}
...
An event with a defined start (September 17, 2011), but without a concrete end is the Occupy Wall Street movement.
...
%TS: Corrected.
For this paper, we have semi-automatically deduplicated the images with the aid of content-based image retrieval (CBIR) image duplication detection software\footnote{PhotoSweeper: \url{http://itunes.apple.com/us/app/photosweeper/id463362050?mt=12}}, and have completely manually deduplicated the videos.
...
%TS: Fair enough. Removed. It just says it could be done, but many things could be done.
...
%TS: the point is, if you shrink a wiiiiiiiiide banner to a square, a lot of the information gets lost. Clearer now?
