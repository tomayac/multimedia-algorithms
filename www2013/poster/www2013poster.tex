...
One via multiple social networks, where we simply asked people to ``Like''
and/or comment on their favorite type of media gallery,
and one via email to a~company-internal ``miscellaneous'' mailing list,
where we asked people to rate media galleries via MOS, with optional comments. 
For the short surveys on the three social networks Twitter, Facebook,
and \googleplus, we had overall 16 participants (7~female, 8~male, 1~N/A).
...
The users who commented on why they liked \emph{LOVS} more mentioned
they liked the additional structure and tidyness,
the fact that some media items are bigger,
the fact that it is easier to identify individual media items,
and the fact that important media items get featured.
For the email survey with full MOS ratings, we equally had 16 participants
(5~female, 11~male).
