...
:event1
  ...
  event:product [
    ...
    rdf:value """on camera. DAVID CAMERON, British prime
              ...
              back is under way. There are pockets of our
              society that are not just broken, but, frankly,
              sick. When we see children as young as 12 and 13
              looting and laughing, when we see the disgusting
              sight of an injured young man, with people
              pretending to help him while they are robbing him,
              it is clear there are things that are badly wrong
              in our society.  JUDY WOODRUFF:"""@en;
  ];
