...
We therefore define three types of events: \emph{visible events} in the sense of scene changes, \emph{occurrence events} in the sense of the appearance of a named entity, and \emph{interest-based events} in the sense of purposeful in-video navigation by users. 
...
\hspace{10pt}
\subfloat[YouTube search for ``utøya shooting'', scene of a terrible massacre in Norway.]{\label{fig:thumbnails-b}\includegraphics[width=0.3\textwidth]{./resources/utoya}}
...
% MICHAEL: suggest to include the following:
